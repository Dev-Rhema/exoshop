        ...
        <main className="min-h-screen bg-ink flex items-center justify-center px-6">
          <div className="text-center max-w-md">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 bg-[#4a9eff] text-ink font-mono text-xs font-semibold tracking-widest uppercase px-6 py-3 hover:bg-white transition-colors"
            >
              ← Back to Store
            </Link>
          </div>
